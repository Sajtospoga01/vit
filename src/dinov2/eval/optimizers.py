...
print('OPTIMIZER_BUILDERS', OPTIMIZER_BUILDERS)
...
class LearningRateDecayOptimizerConstructorVIT(DefaultOptimizerConstructor):
            ...
            if 'layer_wise' in decay_type:
                ...
                if 'ConvNeXt' in module.backbone.__class__.__name__:
                    ...
                    logger.info(f'set param {name} as id {layer_id}')
                     ...
                     'ViTAdapter' in module.backbone.__class__.__name__:
