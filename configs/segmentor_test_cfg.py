...
data = dict(
    ...
    val=dict(
        type='ADE20KDataset',
        data_root='/nfs/datasets/tune_low_res/',
...
log_config = dict(
    interval=50, hooks=[
        ...
        # dict(type='ProgressBarLoggerHook'),  # Enables the progress bar.
        dict(
...
checkpoint_config = dict(by_epoch=False, interval=500, max_keep_ckpts=1,out_dir='/notebooks/',file_client_args=dict(backend='disk'))
evaluation = dict(
...
fp16 = False
work_dir = '/checkpoint/dino/evaluations/segmentation/dinov2_vitg14_ade20k_m2f'
gpu_ids = range(0, 16)
auto_resume = True